...
public class cargarDatosInicio {
	...
	private static String basePath = inicioPath + "/eclipse-workspace/tpgr45/Tarea2.1/src/main/java/logica/cargar_datos/";
	...
	public static void cargarPostulantes(IControladorUsuario ICU) throws ObjetoRepetidoException, IOException, ParseException, ObjetoNoRespetaFormatoException {
		     ...
		     linea = bufferLectura.readLine();
			  ...
			  while (linea != null) {
				   ...
				   if (tipo.equals("P")) {
					   ...
					   DTPostulante dtpostulante = new DTPostulante(nickname, nombre, apellido, email, clave, img, rol, fecha_nac, nacionalidad);
        ...
        bufferLectura2 = new BufferedReader(new FileReader(basePath + "Usuarios-Postulantes.csv"));
	     ...
	     linea2 = bufferLectura2.readLine();
		  ...
		  while (linea2 != null) {
				   ...
				   DTPostulante dtpostulante2 = new DTPostulante(
						   postulante.getNickname(), postulante.getNombre(), postulante.getApellido(), postulante.getCorreo(),
						   postulante.getClave(), postulante.getImagen(), postulante.getRol(),
						   fechaFormat, nac
				   );
	...
	public static void cargarEmpresas(IControladorUsuario ICU) throws ObjetoRepetidoException, IOException, ObjetoNoRespetaFormatoException {
		     ...
		     linea = bufferLectura.readLine();
			  ...
			  while (linea != null) {
				   ...
				   if (tipo.equals("E")) {
					   ...
					   DTEmpresa dtempresa = new DTEmpresa(nickname, nombre, apellido, email,
							   clave, img, rol,
	     ...
	     linea2 = bufferLectura2.readLine();
		  ...
		  while (linea2 != null) {
				   ...
				   DTEmpresa dtempresa2 = new DTEmpresa(
						   empresa.getNickname(), empresa.getNombre(), empresa.getApellido(), empresa.getCorreo(),
						   empresa.getClave(), empresa.getImagen(), empresa.getRol(),
						   codigo, desc, web
				   );
	...
	public static void cargarPaquetes(IControladorTipoPublicacion ICTP) throws ObjetoRepetidoException, ParseException, ObjetoNoRespetaFormatoException {
		 try {
	...
	public static void cargarTipoPublicacion(IControladorTipoPublicacion ICTP) throws ObjetoRepetidoException, ParseException, ObjetoNoRespetaFormatoException {
		 try {
	...
	public static void cargarTipoPublicacionEnPaquete(IControladorTipoPublicacion ICTP) throws ObjetoRepetidoException, ParseException, ObjetoNoExisteException {
		 try {
	...
	public static void cargarOfertasLaborales(IControladorOfertaLaboral ICOL) throws ObjetoRepetidoException, ParseException, ObjetoNoExisteException {
		 try {
		     ...
		     linea = bufferLectura.readLine();
			  ...
			  while (linea != null) {
				  ...
				  DTOfertaLaboral dtol2 = new DTOfertaLaboral(nombre, desc, ciudad, departamento, horario, remuneracion, fechaFormat, estado, paquete, img, keylist, empresa, tipopublicacion);
	...
	public static void cargarPostulaciones(IControladorUsuario ICU) throws ObjetoRepetidoException, ParseException, ObjetoNoExisteException {
		 try {
		     ...
		     linea = bufferLectura.readLine();
			  ...
			  while (linea != null) {
				   ...
				   DTPostulanteOfertaLaboral dt = new DTPostulanteOfertaLaboral(fechaFormat, cv, motivacion, "", postulante, ol);
	...
	public static void cargarCompraPaquetes(IControladorTipoPublicacion ICTP) throws ObjetoNoExisteException, IOException, ParseException {
