...
public class DTOfertaLaboral {
	...
	public DTOfertaLaboral(String nombre, String descripcion, String ciudad, String departamento, String horario,
			...
			DTTipoPublicacion tipo_publicacion, Map<String, DTKeyword> keywords, EnumEstadoOL estado, String img) {
	...
	public DTOfertaLaboral(String nombre, String descripcion, String ciudad, String departamento, String horario,
						   ...
						   Float remuneracion, Date fecha_alta, String estado, String paquete, String img, List<String> keylist, DTEmpresa empresa, DTTipoPublicacion tipoPublicacion) {
		...
		this.tipoPublicacion = tipoPublicacion;
		 Map<String,DTKeyword> keywordsLista= new HashMap<String, DTKeyword>();
		for(int i = 0; i<keylist.size(); i++) {
			Keyword kwrd = new Keyword();
			kwrd.setNombre(keylist.get(i));
			keywordsLista.put(keylist.get(i), kwrd.getDT());
		}
		this.keywords = keywordsLista;
		this.postulaciones = new HashMap<String, DTPostulanteOfertaLaboral>();
	}
