...
public class DTPaquete {
	...
	public DTPaquete(String nombre, String descripcion, Integer validez_dias, Float descuento, Date fecha_alta, Map<String, DTPaqueteTipoPublicacion> tipos_publicaciones, Float costo, String img) {
		super();
		this.nombre = nombre;
		this.descripcion = descripcion;
		this.validezDias = validez_dias;
