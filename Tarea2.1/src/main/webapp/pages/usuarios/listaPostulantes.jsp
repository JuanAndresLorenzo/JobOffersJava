...
<% DTPostulante[] dts_objetos = (DTPostulante[]) request.getAttribute("dts_objetos"); %>
								...
								<div class="col col-3">
									...
									<% if (dts_objetos[i].getImagen() != null && !dts_objetos[i].getImagen().isEmpty()) { %>
											...
											<img class="img-fluid" title="Imagen <%= dts_objetos[i].getNickname() %>"
												src="<%= request.getContextPath() %>/assets/images/usuarios/postulante/<%= dts_objetos[i].getImagen() %>">
