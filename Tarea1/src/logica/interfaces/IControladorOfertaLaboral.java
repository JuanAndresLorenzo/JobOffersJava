...
public interface IControladorOfertaLaboral {
	...
	public abstract DTPostulanteOfertaLaboral getDataPostulacionOfertaLaboral(String oferta_nombre,
			String postulante_nickname) throws ObjetoNoExisteException;
