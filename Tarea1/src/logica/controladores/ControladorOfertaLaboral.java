...
public class ControladorOfertaLaboral implements IControladorOfertaLaboral {
	...
	public DTOfertaLaboral[] listarOfertasLaboralesVigentesConfirmadas() throws ObjetoNoExisteException {
		...
		if (ofertas_laborales != null) {
			...
			DTOfertaLaboral[] dts_ofertas_laborales_vigentes_confirmadas = new DTOfertaLaboral[ofertas_laborales_vigentes_confirmadas
					.size()];
	...
	public DTPostulanteOfertaLaboral getDataPostulacionOfertaLaboral(String oferta_nombre, String postulante_nickname)
		...
		if (oferta_laboral != null) {
			...
			throw new ObjetoNoExisteException("La oferta laboral " + oferta_nombre + " no existe");
		}
	...
	public void registrarOfertaLaboral(DTOfertaLaboral data_oferta_laboral) throws ObjetoRepetidoException {
		...
		if (ofertaLaboral == null) {
			...
			OfertaLaboral ol = new OfertaLaboral(empresa, tipo_publicacion, data_oferta_laboral.getNombre(),
					data_oferta_laboral.getDescripcion(), data_oferta_laboral.getCiudad(),
					data_oferta_laboral.getDepartamento(), data_oferta_laboral.getHorario(),
					data_oferta_laboral.getRemuneracion(), enumEstado, paqueteObjeto, data_oferta_laboral.getImg(),
					data_oferta_laboral.getFechaAlta());
