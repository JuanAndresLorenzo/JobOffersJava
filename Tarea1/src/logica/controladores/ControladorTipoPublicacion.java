...
//                        paquete.getValidezDias(), paquete.getDescuento(), paquete.getFechaAlta());
	...
	public DTPaqueteTipoPublicacion[] listarTiposPublicacionesPorPaquete(String paquete_nombre)
		...
		if (paquete != null) {
			...
			if (!tipos_publicaciones_de_paquete.isEmpty()) {
				...
				throw new ObjetoNoExisteException(
						"El paquete " + paquete_nombre + " no tiene tipos de publicaciones asociadas");
	...
	public void ingresarTipoPublicacion(DTTipoPublicacion dt_tipo_publicacion)
	...
	public void agregarTipoPublicacionAPaquete(String paquete_nombre, String tipo_publicacion_nombre, Integer cantidad)
		...
		PaqueteTipoPublicacion paquete_tipo_publicacion = new PaqueteTipoPublicacion(paquete, tipo_publicacion,
				cantidad);
		paquete.agregarTipoPublicacion(paquete_tipo_publicacion);

	}

	public void compraPaquete(String empresa_nickname, String paquete_nombre, Date fecha, Float costo)
			throws ObjetoNoExisteException {
		...
		System.out.println("COMPRA PAQUETE existe  " + paquete_nombre + "------>"
				+ empresa.existePaqueteComprado(paquete.getKey()));
